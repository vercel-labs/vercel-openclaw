...
- [[sandbox-lifecycle]] — Sandbox state machine, triggers, locking, cron wake, token refresh, and all user stories

## Design scratch routes

Production admin shell mounted at `/` via `src/components/designs/command-shell.tsx`.
